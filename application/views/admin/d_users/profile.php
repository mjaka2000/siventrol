                        ...
                        <div class="card-primary card-outline card-tabs">
                            <div class="card-header p-2">
                                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                    ...
                                    <!-- <li class="nav-item">
                                        <a href="#" class="nav-link" data-toggle="pill" href="#custom-tabs-three-profile" role="tab" aria-controls="custom-tabs-three-profile" aria-selected="false">Ganti Gambar</a>
                                    </li> -->
                                    <!-- <li class="nav-item">
                                    ...
                                    <div class="tab-pane fade show active" id="settings" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                                        ...
                                        <form class="form-horizontal" action="<?= site_url('admin/proses_newpassword'); ?>" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" value="<?= $this->session->userdata('nama_lengkap'); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
