                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php } ?>
                            <button onclick="window.location.href='<?= site_url('admin/tambah_pelanggan'); ?>'" style="margin-bottom:10px;" type="button" class="btn btn-sm btn-primary" name="tambah_data"><i class="fa fa-plus"></i>&nbsp;Tambah Data</button>
                                    ...
                                    if (is_array($list_data)) { ?>
                                        <?php foreach ($list_data as $d) : ?>
                                            <tr>
                                                ...
                                                <td><?= $d->kota_pelanggan; ?></td>
                                                <td><?= $d->email_pelanggan; ?></td>
                                                <td><?= $d->kontak_pelanggan; ?> </td>
                                                <td>
